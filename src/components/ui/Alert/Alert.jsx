...
// Варианты иконок
const iconVariants = {
  info: <Icon name="info" className="w-6 h-6 text-blue-600" />,
  warning: <Icon name="warning" className="w-6 h-6 text-amber-600" />,
  success: <Icon name="checkmark-outline" className="w-6 h-6 text-emerald-600" />,
...
export const Alert = ({
  ...
  return (
    <div
      ...
      } fixed z-2 w-[350px] px-3 py-2 rounded-sm`}
      role="alert"
    >
